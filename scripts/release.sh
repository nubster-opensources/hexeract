#!/usr/bin/env bash
#
# scripts/release.sh: opinionated release preparation wrapper for Hexeract.
#
# Usage:
...
new_links = (
    "[Unreleased]: https://github.com/nubster-opensources/hexeract/compare/v"
    + new_version
    + "...HEAD\n["
    + new_version
    + "]: https://github.com/nubster-opensources/hexeract/releases/tag/v"
    + new_version
)
